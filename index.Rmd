...
subtitle: "Disciplina: Estatística Experimental - IC 284"
author: |
  | Wagner Tassinari 
  |
date: "2025"
...
```{r, echo=FALSE, fig.align="center", out.width="100%", out.height="20%"}
knitr::include_graphics("figure/ufrrj.jpeg")
```

```{r, echo=FALSE, fig.align="center", out.width="40%", out.height="20%"}
knitr::include_graphics("figure/eucaliptus.jpg")
```
...
# p2 <- ggdraw() + draw_image('figure/eucaliptus.jpg', vjust = 0.5, scale = 0.9)
# plot_grid(p1, p2)
